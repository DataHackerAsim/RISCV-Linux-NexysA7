> **Note:** This document is adapted from the
> [linux-on-litex-vexriscv](https://github.com/litex-hub/linux-on-litex-vexriscv)
> upstream project by LiteX-Hub. Peripheral addresses and GPIO numbers are specific
> to the Nexys A7-100T SoC configuration generated by this project.
